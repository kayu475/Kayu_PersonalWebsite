...
const layer3 = [
    ...
    {id:"Glimpse of Anxious Time",   parent:"Installation", group:"work"},  // ← NEW
    // Coding
    ...
    {id:"Gossip Gambler",            parent:"Video Editing", group:"work"},  // ← NEW
    // Creative Writing
...
// ← NEW: Dotted line from "Glimpse of Anxious Time" → Photography
...
/* Button hover effect (your previous request) */
d3.selectAll(".intro_button").style("transition","background-color .25s").on("mouseover",function(){d3.select(this).style("background-color","#e67e68")}).on("mouseout",function(){d3.select(this).style("background-color","lightsalmon")});